...
public class RmssdHistoryFragment extends BaseResourceFragment {
    ...
    public void setMaximum(int value) {
        _maximum = value;
        String date = CalendarUtil.dayUnixToDate(_maximum);
        if (_created)
            updateMaximum();
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        if (_startTime != null)
            getRmssds(userSettings.getId(), _startTime, _endTime);
    ...
    protected void drawChart(List<AvgStress> stresses) {
        ...
        maxLevelEntries.add(new Entry(0, userSettings.getStressLevelMax()));
        maxLevelEntries.add(new Entry(100000000000l, userSettings.getStressLevelMax()));
